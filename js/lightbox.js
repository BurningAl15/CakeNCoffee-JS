(function () {
  ...
  //Objeto con las Métodos del efecto lightbox
  var metLightbox = {
    inicio: function () {
    ...
    lightbox: function (imagen) {
      ...
      //slice(from this, to this)
      propLightbox.cuerpoDom
        .appendChild(document.createElement("DIV"))
        .setAttribute("id", "lightbox_container");

      propLightbox.lightbox_container = document.getElementById(
        "lightbox_container"
      );
      ...
      propLightbox.modal.innerHTML +=
        '<i id="cerrar_modal" class="fa fa-times" aria-hidden="true"></i>';
